...
btn_check_answer.addEventListener('click', () => {
   if (value_answer.value == 'vũng tàu' || value_answer.value == 'Vũng Tàu') {
      ...
      const new_icon = document.createElement('ion-icon');
      new_icon.innerText('<ion-icon name="checkmark-circle-outline"></ion-icon>');
      input_answer.replaceChild(new_icon, icon);
   }
});
